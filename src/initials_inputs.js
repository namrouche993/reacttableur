...
// import { ddatafct,data22fct } from './data.js';
  ...
  //#endregion initials inputs nb
      ...
      export var userTimeZone = secureLocalStorage.getItem("userTimeZone_storage") ? secureLocalStorage.getItem("userTimeZone_storage") : Intl.DateTimeFormat().resolvedOptions().timeZone; //'America/New_York'
